...
- Leia e execute `.claude/commands/setup/build-business.md`
- Ao finalizar, retorne ao menu (Fase 3) com status atualizado

**`🔧 Documentação Técnica`**
- Leia e execute `.claude/commands/setup/build-tech.md`
- Ao finalizar, retorne ao menu (Fase 3) com status atualizado

**`🔍 Atualização de Contexto`**
- Leia e execute `.claude/commands/setup/discover.md`
